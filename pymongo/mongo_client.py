...
class MongoClient(common.BaseObject):
    ...
    def _writable_max_wire_version(self):
        ...
        """
        cluster = self.get_cluster()  # Starts monitors if necessary.
    ...
    def get_cluster(self):
        ...
        If this client was created with "connect=False", calling get_cluster
    ...
    def copy_database(self, from_name, to_name,
        ...
        # get_cluster() starts connecting, if we initialized with connect=False.
        server = self.get_cluster().select_server(
            writable_server_selector)
